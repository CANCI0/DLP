...
public class GrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MAS", "MENOS", "POR", "ENTRE", "IGUAL", "DESIGUAL", "P", "COMA", "PCOMA", 
			"PP", "READ", "VAR", "PRINT", "INT", "FLOAT", "IF", "ELSE", "AND", "OR", 
			"C_START", "C_END", "P_START", "P_END", "L_START", "L_END", "F_START", 
			"F_END", "INT_LITERAL", "REAL_LITERAL", "CHAR_LITERAL", "IDENT", "LINE_COMMENT", 
