...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		BOOL_LITERAL=44, IDENT=45, LINE_COMMENT=46, MULTILINE_COMMENT=47, WHITESPACE=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BOOL_LITERAL", "IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", "WHITESPACE"
		};
	}
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 68171872828432L) != 0) {
				{
				{
				setState(113);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 68171872600080L) != 0) {
					{
					setState(142);
					((StatementContext)_localctx).expression = expression(0);
					}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 4:
				{
				setState(209);
				((ExpressionContext)_localctx).BOOL_LITERAL = match(BOOL_LITERAL);
				 ((ExpressionContext)_localctx).ast =  new BoolLiteral(((ExpressionContext)_localctx).BOOL_LITERAL); 
				}
				break;
			case 5:
				{
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__36:
				...
				setState(285);
				match(T__36);
				 ((TypeContext)_localctx).ast =  new BoolType(); _localctx.ast.updatePositions(_localctx.start); 
				}
				break;
			case T__37:
				enterOuterAlt(_localctx, 3);
