...
public class GrammarParser extends Parser {
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 65972849572880L) != 0) {
				{
				{
				setState(113);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 65972849344528L) != 0) {
					{
					setState(142);
					((StatementContext)_localctx).expression = expression(0);
					}
				...
				if ( _alt==1 ) {
					...
					case 4:
						...
						((ExpressionContext)_localctx).right = ((ExpressionContext)_localctx).expression = expression(7);
						 ((ExpressionContext)_localctx).ast =  new ArrayGt(((ExpressionContext)_localctx).left.ast, ((ExpressionContext)_localctx).op, ((ExpressionContext)_localctx).right.ast); 
						}
						break;
					case 5:
						{
