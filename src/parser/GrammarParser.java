...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_functionCall = 12, RULE_functionCallParams = 13, RULE_type = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"expression", "functionCall", "functionCallParams", "type"
		};
	}
		...
		try {
			...
			case T__8:
				...
				((DefinitionContext)_localctx).varDefinition = varDefinition();
				 _localctx.ast = ((DefinitionContext)_localctx).varDefinition.ast;
				}
				break;
			case T__0:
				...
				setState(49);
				match(T__2);
				 _localctx.ast = new StructDefinition(((DefinitionContext)_localctx).IDENT, ((DefinitionContext)_localctx).attrDefinitions.list);
				}
				break;
			case IDENT:
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			((ParamContext)_localctx).type = type();
			 _localctx.ast = new Param(((ParamContext)_localctx).IDENT, ((ParamContext)_localctx).type.ast);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			case 6:
				...
				if (_la==T__6) {
				 ...
				 _localctx.ast = ((StatementContext)_localctx).functionCall.ast;
				}
				break;
			case 7:
		...
		try {
			...
			case 4:
				...
				((ExpressionContext)_localctx).functionCall = functionCall();
				 ((ExpressionContext)_localctx).ast =  ((ExpressionContext)_localctx).functionCall.ast; 
				}
				break;
			case 5:
				{
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			match(T__3);
			setState(269);
			((FunctionCallContext)_localctx).functionCallParams = functionCallParams();
			setState(270);
			match(T__4);
			_localctx.ast = new FunctionCall(((FunctionCallContext)_localctx).IDENT, ((FunctionCallContext)_localctx).functionCallParams.list);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
