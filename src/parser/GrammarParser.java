...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, INT_LITERAL=41, REAL_LITERAL=42, CHAR_LITERAL=43, 
		IDENT=44, LINE_COMMENT=45, MULTILINE_COMMENT=46, WHITESPACE=47;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, "INT_LITERAL", "REAL_LITERAL", "CHAR_LITERAL", 
	...
	public final DefinitionsContext definitions() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 17592186044930L) != 0) {
				{
				{
				setState(32);
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 32989652679696L) != 0) {
				{
				{
				setState(113);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 32989652189200L) != 0) {
					{
					setState(142);
					((StatementContext)_localctx).expression = expression(0);
					}
			...
			case 9:
				...
				match(T__3);
				setState(173);
				((StatementContext)_localctx).init = statement();
				setState(174);
				((StatementContext)_localctx).cond = expression(0);
				setState(175);
				match(T__6);
				setState(176);
				((StatementContext)_localctx).update = statement();
				setState(177);
				match(T__4);
				setState(178);
				match(T__1);
				...
				setState(180);
				match(T__2);
				 ((StatementContext)_localctx).ast =  new For(((StatementContext)_localctx).init.ast, ((StatementContext)_localctx).cond.ast, ((StatementContext)_localctx).update.ast, ((StatementContext)_localctx).statements.list); 
				}
				break;
			case 10:
