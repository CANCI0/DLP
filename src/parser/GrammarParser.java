...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		STRING=44, IDENT=45, LINE_COMMENT=46, MULTILINE_COMMENT=47, WHITESPACE=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING", "IDENT", "LINE_COMMENT", "MULTILINE_COMMENT", "WHITESPACE"
		};
	}
		...
		try {
			...
			case 4:
				...
				((ExpressionContext)_localctx).STRING = match(STRING);
				 ((ExpressionContext)_localctx).ast =  new StringLiteral(((ExpressionContext)_localctx).STRING); 
				}
				break;
			case 5:
				{
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case T__39:
				...
				setState(291);
				match(T__39);
				 ((TypeContext)_localctx).ast =  new StringType(); _localctx.ast.updatePositions(_localctx.start); 
				}
				break;
			case T__18:
				enterOuterAlt(_localctx, 6);
