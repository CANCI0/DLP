...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, T__41=42, INT_LITERAL=43, REAL_LITERAL=44, 
		CHAR_LITERAL=45, IDENT=46, LINE_COMMENT=47, MULTILINE_COMMENT=48, WHITESPACE=49;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "INT_LITERAL", "REAL_LITERAL", 
	...
	public final DefinitionsContext definitions() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 70368744178178L) != 0) {
				{
				{
				setState(32);
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 131958610361360L) != 0) {
				{
				{
				setState(113);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 131958608756752L) != 0) {
					{
					setState(142);
					((StatementContext)_localctx).expression = expression(0);
					}
			...
			case 8:
				...
				setState(165);
				match(T__6);
				 ((StatementContext)_localctx).ast =  new SumAssignment(((StatementContext)_localctx).left.ast, ((StatementContext)_localctx).right.ast); 
				}
				break;
			case 9:
				...
				setState(171);
				match(T__6);
				 ((StatementContext)_localctx).ast =  new SubAssignment(((StatementContext)_localctx).left.ast, ((StatementContext)_localctx).right.ast); 
				}
				break;
			case 10:
				...
				setState(176);
				match(T__6);
				 ((StatementContext)_localctx).ast =  new Plus(((StatementContext)_localctx).expression.ast); 
				}
				break;
			case 11:
