...
/*
	sumAssignment: statement -> left:expression right:expression
	statement -> 
*/
public class SumAssignment extends AbstractStatement  {
	...
	public SumAssignment(Expression left, Expression right) {
		super();
	...
	public SumAssignment(Object left, Object right) {
		super();
    ...
    public String toString() {
        return "SumAssignment{" + " left=" + this.getLeft() + " right=" + this.getRight() + "}";
    }
