...
/*
	plus: statement -> expression:expression
	statement -> 
*/
public class Plus extends AbstractStatement  {

    // ----------------------------------
    // Instance Variables

	// plus: statement -> expression
    ...
    public String toString() {
        return "Plus{" + " expression=" + this.getExpression() + "}";
    }
