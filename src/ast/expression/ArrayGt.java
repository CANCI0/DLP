...
/*
	arrayGt: expression -> left:expression operator:string right:expression
	expression -> 
...
*/
public class ArrayGt extends AbstractExpression  {
	...
	public ArrayGt(Expression left, String operator, Expression right) {
		super();
	...
	public ArrayGt(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "ArrayGt{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
