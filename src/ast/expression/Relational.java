...
/*
	relational: expression -> left:expression operator:string right:expression
	expression -> 
...
public class Relational extends AbstractExpression  {
	...
	public Relational(Expression left, String operator, Expression right) {
		super();
	...
	public Relational(Object left, Object operator, Object right) {
		super();
    ...
    public String toString() {
        return "Relational{" + " left=" + this.getLeft() + " operator=" + this.getOperator() + " right=" + this.getRight() + "}";
    }
